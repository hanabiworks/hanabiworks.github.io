...
Bem-vindo ao primeiro blogpost da HanabiWorks, querido leitor. Seu redator ninguém menos que o Hakata. Já tive experiência escrevendo blogs antes, graças ao [Fuwanovel](https://fuwanovel.moe/author/hakata/), mas nada extremamente pessoal como este.
...
<div class="row">
    <div class="rounded mx-auto d-block">
        {% include figure.liquid loading="eager" path="assets/img/post_01_02.png" title="example image" class="img-thumbnail rounded" %}
    </div>
</div>
<div class="caption">
    Capa do jogo
...
<div class="row justify-content-center">
    <div class="rounded mx-auto d-block col-9 ">
        {% include figure.liquid loading="eager" path="assets/img/post_01_01.png" title="example image" class="thumbnail rounded" %}
    </div>
</div>
<div class="caption">
...
<div class="row justify-content-center">
    <div class="rounded mx-auto d-block col-9 ">
        {% include figure.liquid loading="eager" path="assets/img/post_01_03.png" title="example image" class="thumbnail rounded" zoomable=true %}
    </div>
</div>
<div class="caption">
...
<div class="row justify-content-center">
    <div class="rounded mx-auto d-block col-10 ">
        {% include figure.liquid loading="eager" path="assets/img/post_01_04.png" title="example image" class="thumbnail rounded" %}
    </div>
</div>
<div class="caption">
...
<h5 class="text-center fw-semibold fs-3">(As letras, caso tenham curiosidade)</h5>
...
<div class="row justify-content-center">
    <div class="rounded mx-auto d-block col-9">
        {% include figure.liquid loading="eager" path="assets/img/post_01_05.png" title="example image" class="thumbnail rounded" zoomable=true %}
    </div>
</div>
<div class="caption">
